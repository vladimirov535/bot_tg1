...
# Тексты сообщений
TEXT_0 = """Если вы рассматриваете продажи на маркетплейсах или открыть свой интернет-магазин и думаете о поставках из Китая, но вас останавливают документы, таможня и «белый» ввоз — это видео для вас.
...
Посмотрите внимательно, рассказываю, как после нашего обучения вы сможете заказывать из Китая с документами партии от $300"""
...
Белый импорт — это не про «сложно и дорого».
Это про понимание процесса, цифр и рисков.

Если вы планируете привозить и продавать товары из Китая, то разобраться в этом один раз — намного выгоднее, чем постоянно действовать наугад. 

Ниже — программа обучения, где я собрал всё, что сам использую на практике 👇"""
TEXT_50H = """Как зарабатывать $850 в месяц?
...
Как подработка 850 долларов в месяц - легко!
...
Пишите слово "КИТАЙ" менеджеру и получите стоимость обучения"""
